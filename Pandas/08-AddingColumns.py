...
#Adding Column using square brackets , use direct method if loction does not matter
df["Bonus"]=df["Salary"]*0.1
print(df)

# Adding Colum using insert(loc,column name,values) method ,use insert method when you want add column at some specific postion
li=[]
for i in range(1,31):
    li.append(100+i)
df.insert(0,"Employee ID",li)
print(df)